...
class SubscribedUsersChart extends Component{
    static propTypes = {
    ...
    constructor(props) { 
        ...
        this.GetUserSubscriptionStatistics = () => {
            ...
            axios.post(Backend_Server_Address + 'getUserSubscriptionStatistics', data, { headers: { 'access_token': cookies.get(Access_Token_Cookie_Name) }  })
            .then((res) => {
                let result = res.data
                // set users to state
    ...
    render() {
        return (
            <div>
                <Helmet>
                    <title>Subscribed Users Chart | {Platform_Name}</title>
...
export default withCookies(SubscribedUsersChart);